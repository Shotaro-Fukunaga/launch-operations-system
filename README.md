...
### 打ち上げ動画
実際にシステムを動かすのは難しいと思うので、動作確認用の動画を作成しています。ご興味がある方は是非ご覧ください。  
動画では、種子島宇宙センターからISS（国際宇宙ステーション）の軌道を目標に打ち上げを行っています。 
https://www.youtube.com/watch?v=Kp07lE_Vb8E

### ISSの軌道情報
**軌道高度**： 約400km  
**軌道傾斜角**： 51.6°  
**軌道周期**： 約92分  
**軌道速度**： 約28,000 km/h (7.66 km/s)  
**軌道形状**： ほぼ円形の低地球軌道 (LEO)  
